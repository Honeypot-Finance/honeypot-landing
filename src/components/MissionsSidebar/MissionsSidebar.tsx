...
const recommendedMoves: RecommendedMove[] = [
  ...
  },
  {
    ...
    description: 'Stake HoneyGenesis NFTs to earn continuous reward tokens while maintaining ownership',
    icon: '🎨',
    action: 'Stake Now',
  ...
  },
  {
    id: '3',
    title: 'AIOV Vault',
    description: 'Burn tokens in the All in One Vault to claim your share of $LBGT rewards',
    icon: '🔥',
    action: 'Enter Vault',
    ...
    <div className={styles['missions-sidebar']}>
      ...
      <div className={styles['missions-list']}>
        {recommendedMoves.map((move) => (
          ...
          >
            <div className={styles['move-icon-wrapper']} style={{ background: move.gradient }}>
            ...
            <div className={styles['mission-content']}>
              ...
              <p className={styles['mission-description']}>{move.description}</p>
              <button
