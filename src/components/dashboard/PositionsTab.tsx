      ...
      <div className="liquidity-section">
        <div className="section-header">
          <div
            ...
            title="Your current liquidity pools and vault positions"
          >
            <svg
              width="24"
              height="24"
        ...
        <div className="dex-sub-tabs">
          <button
            className={`sub-tab ${
              liquiditySubTab === "concentrated" ? "active" : ""
            }`}
            ...
            {positionsLoading ? (
              ...
              <div className="empty-state positions-empty">
                ...
                <div className="empty-content">
                  ...
                  <p>
                    You don&apos;t have any active concentrated liquidity
                    positions. Start providing liquidity to earn trading fees!
                  </p>
                  <button
            ...
            {vaultSharesLoading ? (
              ...
              <div className="empty-state positions-empty">
                ...
                <div className="empty-content">
                  ...
                  <p>
                    You don&apos;t have any automated vault positions. Let
                    vaults optimize your liquidity strategy automatically!
                  </p>
                  <button
                    className="empty-cta primary"
                    onClick={() =>
                      window.open(
                        `${DEX_DOMAIN}pools?opentab=vault`,
                        "_blank",
                        "noopener,noreferrer"
                      )
                    }
