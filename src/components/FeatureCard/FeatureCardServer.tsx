 ...
 * Uses Next.js Link for navigation instead of onClick handlers
 * This allows the component to be server-rendered for better SEO
 */
export default function FeatureCardServer({
  ...
  const cardClassName =
    "rounded-[32px] p-6 flex flex-col items-center justify-between hover:border-[#FFCD4D] transition-all duration-300 cursor-pointer group relative hover:scale-105 hover:shadow-2xl";
